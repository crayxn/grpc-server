...
namespace Crayxn\GrpcServer\Health\HealthCheckResponse;
...
class_alias(ServingStatus::class, \Crayxn\GrpcServer\Health\HealthCheckResponse_ServingStatus::class);
