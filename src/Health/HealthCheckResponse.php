...
use Crayxn\GrpcServer\Health\Health;
...
class HealthCheckResponse extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \Crayxn\GrpcServer\Health\GPBMetadata\Health::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Crayxn\GrpcServer\Health\HealthCheckResponse\ServingStatus::class);
        $this->status = $var;
